...
const ExperienceTimeline = () => {
    ...
    return (
        <div id='experience'>
            <div className="mt-10 sm:mt-20 sm:gap-10 text-center">
				<p className="font-general-medium text-2xl sm:text-4xl mb-1 text-ternary-dark dark:text-ternary-light ">
					{experienceHeading}
				</p>
			</div>
            <div className="text-right float-right mt-10 sm:mt-20">
                <img width="350px" src={ExperienceImage} alt="experience-worker" />
            </div>
            <div className='float-left mt-10 sm:mt-20 gap-2 sm:gap-0'>
